...
#test_batch and train_batch are used to calculate accuracy
...
#load word_dict and word_embedding
word_dict = make_word_dictionary()
word_emb = make_word_embedding(word_dict)

#session configuration for using GPU
